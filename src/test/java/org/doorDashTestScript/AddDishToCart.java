...
public class AddDishToCart {
	public static void main(String[] args) {
	    ...
	    driver.findElement(By.xpath("//a[text()='Yorkshire Lamb Patties']/ancestor::div[@class='content']//div/following-sibling::div/a[@href='dishes.php?res_id=1']")).click();
